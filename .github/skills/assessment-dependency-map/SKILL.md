...
3. **Generate Diagram**:
   ...
   - Save to `.github/modernize/assessment-dependency-map.md`
...
- Saves diagram to `.github/modernize/assessment-dependency-map.md`

## Diagram Output

The generated diagram will be saved to:

- `.github/modernize/assessment-dependency-map.md`
...
- Diagram saved to `.github/modernize/assessment-dependency-map.md`
