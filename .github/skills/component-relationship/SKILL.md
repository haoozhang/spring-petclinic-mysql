...
3. **Generate Diagram**:
   ...
   - Save to `.github/modernize/component-relationship.md`
...
- Saves diagram to `.github/modernize/component-relationship.md`

## Diagram Output

The generated diagram will be saved to:

- `.github/modernize/component-relationship.md`
...
- External dependencies (covered by dependency-map skill)
...
- Diagram saved to `.github/modernize/component-relationship.md`
